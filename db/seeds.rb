...
map = Map.create(name: "Map 1", data: map1_data.to_json, challenge_id: first_challenge.id, map_url: "/assets/map2.png")
...
map = Map.create(name: "Map 1", data: map2_data.to_json, challenge_id: 2, map_url: "/assets/map3.png")
...
map = Map.create(name: "Map 3", data: map3_data.to_json, challenge_id: 3, map_url: "/assets/map4.png")